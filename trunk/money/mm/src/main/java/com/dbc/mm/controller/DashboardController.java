...
public class DashboardController extends AbstractApplicationController {
	...
	public @ResponseBody String getMovie(@RequestParam("transactionId") String transactionId, @RequestParam("categoryId") String categoryId, Model model){
		logger.debug("**********" + transactionId + " " + categoryId);
	    return "value";
	}
